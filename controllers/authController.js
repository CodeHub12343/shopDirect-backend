...
// Function to sign JWT with user ID
const signToken = (id) => {
...
const createSendToken = (user, statusCode, res) => {
  ...
  const cookieOptions = {
    ...
    httpOnly: true, // cannot be accessed via JS (for security)
  };

  // Send secure cookie only in production
...
exports.signUp = catchAsync(async (req, res, next) => {
  const newUser = await User.create({
    ...
    role: req.body.role, // optional: only allow if req.body.role exists
  });
...
// Accepts any number of roles, returns middleware
